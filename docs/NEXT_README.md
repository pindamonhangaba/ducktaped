...
This extension, Ducktaped, allow you to ... <extension_goal>.
...
./build/release/extension/ducktaped/ducktaped.duckdb_extension
```
- `duckdb` is the binary for the duckdb shell with the extension code automatically loaded.
- `unittest` is the test runner of duckdb. Again, the extension is already linked into the binary.
- `ducktaped.duckdb_extension` is the loadable binary as it would be distributed.
